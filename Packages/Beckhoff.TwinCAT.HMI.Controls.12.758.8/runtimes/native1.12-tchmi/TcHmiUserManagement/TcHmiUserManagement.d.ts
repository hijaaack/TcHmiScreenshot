...
declare module TcHmi.Controls.Beckhoff.TcHmiUserManagementPopups {
    abstract class Popup {
        ...
        /** The popup to show notifications */
        protected __notificationPopup: TcHmiUserManagementPopups.NotificationPopup | undefined;
        /** The popup to show warnings */
        protected __warningPopup: TcHmiUserManagementPopups.WarningPopup | undefined;
        /** Localization */
         ...
         * @param text The text displayed in the popup
         * @param headline the headline of the popup
         */
        protected __showNotification(text: string | {
            key: string;
            parameters?: any[];
        }, headline: string | {
            key: string;
         ...
         * @param text The text displayed in the popup
         * @param headline the headline of the popup
         * @param okFunction the function executed after the click on 'OK'
         */
        protected __showWarning(text: string | {
            key: string;
            parameters?: any[];
        }, headline: string | {
            key: string;
            parameters?: any[];
        }, okFunction: () => void): void;
    }
}
declare module TcHmi.Controls.Beckhoff.TcHmiUserManagementPopups {
    /**
